package com.arbaelbarca.tourtravel.Utils;
...
public class GpsLocation {
    ...
    public static interface Listener {
        ...
        /** Called whenever the device's position changes so that you can call {@link GpsLocation#getPosition()} */
     ...
     *
     * @param listener the `GpsLocation.Listener` instance to attach or `null` to detach
     */
    ...
    public boolean isFromMockLocation(){
        if(Build.VERSION.SDK_INT < Build.VERSION_CODES.JELLY_BEAN_MR2){
            return !Settings.Secure.getString(this.mContext.getContentResolver(), Settings.Secure.ALLOW_MOCK_LOCATION).equals("0");
        }else if(Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN_MR2){
            return Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN_MR2 && mCachedPosition != null && mCachedPosition.isFromMockProvider();
        }
